...
(use-modules (gnu)
           ...
           (gnu services docker)            ; Added for docker-service-type
           (gnu packages)
           (gnu packages linux)
           ...
           ;; REMOVED: (gnu packages wayland) - this module doesn't exist
...
(services (append
           (list (service network-manager-service-type)
                 ...
                 ;; Docker services (required for "docker" group to work)
