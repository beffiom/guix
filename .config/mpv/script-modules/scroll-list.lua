...
function scroll_list:new()
    ...
    vars = {
        ...
        keybinds = {
            ...
            {'J', 'move_pagedown', function() vars:move_pagedown() end, {}},
            {'K', 'move_pageup', function() vars:move_pageup() end, {}},
            {'gg', 'move_begin', function() vars:move_begin() end, {}},
            {'G', 'move_end', function() vars:move_end() end, {}},
