...
local o = {
    ...
    key_move_begin = "gg HOME",
    key_move_end = "G END",
    key_move_pagedown = "J PGDWN",
    key_move_pageup = "K PGUP",
    key_scroll_down = "j DOWN WHEEL_DOWN",
    key_scroll_up = "k UP WHEEL_UP",
    key_open_chapter = "l ENTER MBTN_LEFT",
