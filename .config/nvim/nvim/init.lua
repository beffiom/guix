...
vim.api.nvim_create_autocmd( { "BufWritePost" }, { pattern = { "/etc/nixos/configuration.nix" }, command = [[ !sudo nixos-rebuild switch --upgrade --flake ~/.config/home-manager --impure]], })
